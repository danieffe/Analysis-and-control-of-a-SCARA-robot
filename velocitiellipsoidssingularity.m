...
J= [-a(1)*sin(teta(1))-a(2)*(sin((teta(1)+teta(2)))) , (-a(2)*(sin(teta(1)+teta(2))));
 ...
 determinanteJ=[-a(1)*sin(teta(1))-a(2)*(sin((teta(1)+teta(2))))*(a(2)*(cos(teta(1)+teta(2))))-(-a(2)*(sin(teta(1)+teta(2))))*(a(1)*cos(teta(1))+a(2)*(cos(teta(1)+teta(2))))]
%forza
 [V,G]=eig(J*J');
 %velocità
 [U,D]=eig((J*J')^-1);
